...
<Content>
    <article>
        ...
        <A href={post.app_url}><h2>Clique aqui para testar</h2></A>
        <PostContent />
        <div style="padding: 30px 0px">
            <p><b>Publicado:</b> {post.created_at}</p>
            <p><b>Atualizado:</b> {post.updated_at}</p>
            <p><b>Repositório:</b> {post.repository}</p>
            <p><b>Licença:</b> {post.license}</p>
            <p><b>Linguagens de programação:</b> {post.languages.join(", ")}</p>
            <p><b>Tecnologias:</b> {post.technologies.join(", ")}</p>
        </div>
    </article>
</Content>
