import{t as m,b as g}from"./BAQlJMdJ.js";import"./jhujCLip.js";import{s as a,k as h,a4 as n,a5 as s,n as v}from"./l2PV5vIv.js";import{h as t}from"./PcRRlBoN.js";const y={title:"HTML And Components",description:"Why React became so popular? How was the way here?",created_at:"2024-06-31",updated_at:"2025-02-20",technologies:["HTML","React"]},{title:_,description:C,created_at:T,updated_at:A,technologies:H}=y;var f=m(`<h1 id="html-e-componentes"><a aria-hidden="true" tabindex="-1" href="#html-e-componentes"><span class="icon icon-link"></span></a>HTML E Componentes</h1> <p>Por que o React se tornou tão popular? Como foi o caminho até aqui?</p> <h2 id="do-html-ao-react"><a aria-hidden="true" tabindex="-1" href="#do-html-ao-react"><span class="icon icon-link"></span></a>Do HTML Ao React</h2> <p>A web é muito mais recente que o computador e os sistemas operacionais, por conta disso seu
...
componentes</em>.</p> <pre class="language-js"><!></pre> <h2 id="os-impactos-da-componentização"><a aria-hidden="true" tabindex="-1" href="#os-impactos-da-componentização"><span class="icon icon-link"></span></a>Os Impactos Da Componentização</h2> <p>Atualmente, mesmo no <strong>JavaScript vanilla</strong> já é possível criar tags HTML customizadas, através da <strong>API de WebComponents</strong>.</p> <pre class="language-html"><!></pre> <p>A ideia de componentes é tão poderosa que não afetou <em>apenas</em> o cenário de desenvolvimento web. Um
...
layouts baseadas em componentes, e o <strong>Flutter</strong> já foi desenvolvido com isso em mente.</p> <h2 id="conclusão"><a aria-hidden="true" tabindex="-1" href="#conclusão"><span class="icon icon-link"></span></a>Conclusão</h2> <p>Desde o nascimento da web, desenvolvedores buscaram formas de reutilizar o código. A componentização
se mostrou uma <em>forma muito eficaz</em>, e acabou impactando inclusive outras tecnlogias, como o
desenvolvimento de aplicativos móveis.</p>`,1);function L(u){var c=f(),p=a(h(c),10),i=n(p);t(i,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">></span></span>
    ...
    <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>RelativeLayout</span><span class="token punctuation">></span></span></code>`),s(l),v(6),g(u,c)}export{L as default,y as metadata};
